...
- (NSArray<NSArray *> *)notes {
    ...
    // اولین پانویس، همیشه: نسخه دو در حین حرف زدن هیچ متنی نشان نمی‌دهد، فقط نشانِ
    // شنیدن. کسی که نمی‌داند این عمدی است فکر می‌کند اپ گیر کرده.
    ...
    [n addObject:@[@"info.circle", @"جز F و H و B و A، بقیه‌ی حرف‌ها فقط وسط دیکته کار می‌کنند", @NO]];
