    ...
    return @[
        @{@"title": @"تپ روی Command راست",
          @"rows": @[
              ...
              @[@[@"⌘"],       @"pause.circle", @"حرفت که تمام شد، یک بار بزن: متن همین‌جا می‌آید"],
          ]},
        @{@"title": @"Command راست + یک حرف، در حین سشن",
          @"rows": @[
              ...
              @[@[@"E"],     @"square.and.pencil", @"چرخش بین دو حالت: جمع در پنل، کنار کرسر"],
...
- (NSArray<NSArray *> *)notes {
    ...
    if (ZSettings.shared.finalPassEnabled && !ZFinalPass.hasKey) {
        [n addObject:@[@"exclamationmark.triangle",
                       @"پاس هوش مصنوعی روشن است ولی کلید جمینای نیست؛ از منو «کلید Gemini…» را بزن (این پاس فقط روی متن کار می‌کند، نه صدا)",
                       @YES]];
    }
