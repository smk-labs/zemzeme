...
- (NSArray<NSArray *> *)notes {
    ...
    // پلِ میان این کارت و نوار پنل. بی این یک جمله، نوار سیزده آیکونِ بی‌اسم است و
    ...
    [n addObject:@[@"info.circle", @"جز F و H و B و P و A، بقیه‌ی حرف‌ها فقط وسط دیکته کار می‌کنند", @NO]];
