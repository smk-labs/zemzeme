...
// و همان مسیر، بی لانچ: سشن بسته می‌شود و تکه‌ای در راه می‌ماند، پس صفش صاحبِ تازه
// می‌گیرد (B1)، و لایه‌ی بازنویسی با آن می‌رود وگرنه C1 از درِ پشتی برمی‌گردد.
...
// یک بازه از فایل، بر حسب فریمِ ۱۶ کیلوهرتزِ مونو. تکه‌ی در انتظار صدای خودش را
// ذخیره نمی‌کند و از همین‌جا پسش می‌گیرد. نال یعنی خطا (در `err`).
