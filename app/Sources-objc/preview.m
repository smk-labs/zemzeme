...
- (void)open {
    ...
    NSUInteger gen = ++_gen;
    _sec = 0;
    // حدسِ سشنِ قبلی همین‌جا پاک می‌شود، وگرنه سر هر چرخش چند لحظه دوتایی می‌شد:
    // فاینالِ همان حرف‌ها در سطلِ سشنِ بازنشسته می‌نشست و حدسِ کهنه هم هنوز ته متن
    // بود، پس یک عبارت عینا دو بار دیده می‌شد. حالا ته متن یک لحظه کوتاه می‌شود و
    // بعد با فاینال پر، که از دوتا شدن خیلی کم‌آزارتر است.
    _interim = @"";
    [_lock unlock];
