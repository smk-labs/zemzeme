...
// F و H و T استثنا هستند و بیرون از سشن هم کار می‌کنند: پنل رونویسی فایل به سشن
// ربطی ندارد، راهنما را کسی می‌خواهد که هنوز میان‌برها را نمی‌داند (یعنی هنوز سشنی
// هم ندارد)، و تاریخچه را کسی که متنش را گم کرده ــ او هم سشنی ندارد. هزینه‌اش را
// می‌دانیم: Command راست + F و + H و + T دیگر به اپ زیرین نمی‌رسند (Find و Hide و
// New Tab با Command چپ سر جایشان هستند).
- (void (^)(void))actionForCode:(int64_t)code {
    ...
    if (code == 17) return self.onHistory;    // T، همیشه: متنِ گم‌شده را کسی می‌خواهد
                                              // که همین حالا سشنی ندارد
