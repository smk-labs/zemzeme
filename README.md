...
**اگر فایل می‌خواهی:** `Zemzeme-2.2.1.dmg` در
...
۳. **حرفت که تمام شد یک بار Command راست را بزن.** متن یکجا در پنل می‌نشیند و
   می‌بینی‌اش پیش از آنکه جایی برود.
...
- **دو حالت**: «جمع در پنل» (متن در پنل جمع می‌شود و پیش از درج می‌بینی‌اش؛ پنل
  nonactivating است، پس متن انتخاب و کپی می‌شود ولی کیبورد به آن نمی‌رسد) و
