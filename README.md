...
دو گاردِ زیر کد را اجرا نمی‌کنند، متن و شکلِ ریپو را می‌سنجند، پس بی مک و بی کامپایلر
...
ولی همان خط باید نشانِ `[حذف‌شده]` بگیرد تا عمد بودنش دیده شود. مسیری هم که
